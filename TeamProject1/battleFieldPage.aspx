<%@ Page Title="Battle Field" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="battleFieldPage.aspx.cs" Inherits="TeamProject1.battleFieldPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!--Comments for Javid:
        ...
        3) Write code to select the data from tables in consideration to the game
           i.e.  For Battlefield game webpage, select only the data where the game is Battlefield
